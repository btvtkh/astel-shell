...
class AccessPointMenu(Widget.Box):
...
class WifiPage(Widget.Box):
    def __init__(self):
        ...
        page_close_button = Widget.get_child_by_name(self, "wifi-page-close-button")
        scan_button = Widget.get_child_by_name(self, "wifi-page-scan-button")
        toggle_switch = Widget.get_child_by_name(self, "wifi-page-toggle-switch")
        ap_stack = Widget.get_child_by_name(self, "access-points-stack")
        ap_list_box = Widget.get_child_by_name(self, "access-points-list-box")
        ...
        def on_toggle_switch_active(*_):
            if wifi: wifi.set_enabled(toggle_switch.get_active())
