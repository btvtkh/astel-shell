...
def WifiQSB():
    ...
    toggle_button = Widget.get_child_by_name(ret, "wifi-qsb-toggle-button")
    reveal_button = Widget.get_child_by_name(ret, "wifi-qsb-reveal-button")
    status_label = Widget.get_child_by_name(ret, "wifi-qsb-status-label")
    separator = Widget.get_child_by_name(ret, "wifi-qsb-separator")
