...
class ControlPanel(Widget.LayerWindow):
    def __init__(self):
        super().__init__(
            name = "Control-panel",
        ...
        pages_stack = Widget.get_child_by_name(self, "pages-stack")
        wifi_qsb_reveal_button = Widget.get_child_by_name(self, "wifi-qsb-reveal-button")
        wifi_page_close_button = Widget.get_child_by_name(self, "wifi-page-close-button")
        wifi_page_ap_stack = Widget.get_child_by_name(self, "access-points-stack")
        bluetooth_qsb_reveal_button = Widget.get_child_by_name(self, "bluetooth-qsb-reveal-button")
        bluetooth_page_close_button = Widget.get_child_by_name(self, "bluetooth-page-close-button")
